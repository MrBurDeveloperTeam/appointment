...
const SOAP_STORE_ITEMS = [
    { tool: 'soap' as const, label: 'Normal Soap', price: 3, src: '/images/soap.png', description: 'Standard clean' },
    { tool: 'soap2' as const, label: 'Power Soap', price: 8, src: '/images/soap2.png', description: 'More hygiene' },
];
